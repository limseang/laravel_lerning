              ...
              <span class="flex w-full justify-between items-center">
                <span class="flex min-w-0 items-center justify-between space-x-3">
                  ...
                  <span class="flex-1 flex flex-col min-w-0">
                    <span class="text-gray-900 text-sm font-medium truncate">{{$name}}</span>
      ...
      <main class="flex-1">
       ...
       <Header />
        ...
        <div class="px-4 mt-6 sm:px-6 lg:px-8">
          <h2 class="text-gray-500 text-xs font-medium uppercase tracking-wide">{{projects.firstname}}</h2>
...
import Logo from "../../js/views/components/logo.vue";
import Header from "../../js/views/components/header.vue";
