      ...
      <main class="flex-1">
       ...
       <div class="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
          ...
          <div class="mt-4 flex sm:mt-0 sm:ml-4">
            ...
            <button  @click="add_group" type="button" class="order-0 inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 sm:order-1 sm:ml-3">Create Group</button>
          </div>
        </div>
          ...
          <div class="overflow-hidden shadow-sm ring-1 ring-black ring-opacity-5">
            <table class="min-w-full divide-y divide-gray-300">
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr v-for="group in group" >
                 <td class="whitespace-nowrap px-9 py-4 text-sm text-gray-500">{{ group.id }}</td>
                  <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 lg:pl-8">{{ group.name }}</td>
                 
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ group.role }}</td>
                  
                 
                     <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 lg:pr-8">
                    <a @click="editgroup(group.id)"  class="text-indigo-600 hover:text-indigo-900"
                   ...
                   <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 lg:pr-8">
                    <a href="" @click="deleteu(group.id)"  class="text-indigo-600 hover:text-indigo-900"
