        ...
        <input type="hidden" name="_token" :value="csrf">
         ...
         <div>
            ...
            <div class="mt-1">
                ...
                <MultiSelect v-model="permission" :options="permissionList" optionLabel="name" optionValue="code" placeholder="Select Function" display="chip" />
...
const getData = () => {
  axios.get(`/fnt/${route.params.id}`).then(res => {
...
const edit = async (e) => {
    e.preventDefault()
   axios.post(`/edit/fnt/${route.params.id}` ,{
    
 name : name.value,
 permission : permission.value.join('#')
