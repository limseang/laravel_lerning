         ...
         <div>
           ...
           <div>
            ...
            <div class="mt-1">
                ...
                <MultiSelect v-model="form.permission" :options="permissionList" optionLabel="name" optionValue="code" placeholder="Select Permission" display="chip" />
